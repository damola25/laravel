...
<html lang="en">
  ...
  <body>
    ...
    <div id="top" class="header">
      <div class="vert-text">
	  <img class="img-rounded" alt="Company Logo" src="./img/dev1.png"/>
        <h2><em>JadeFolio</em></h2>
		 <!--<ul class="list-inline">
			...
			<br>
			<a href="#about" class="btn btn-top">See More</a>
      </div>
    </div>
    <!-- /Header Area -->
	  <div id="nav">
  ...
  <div class="collapse navbar-collapse" id="mobilemenu">
	  ...
	  <ul class="nav navbar-nav navbar-right text-center">
        ...
        <li><a href="#services"><i class="service-icon fa fa-laptop"></i>&nbsp;Works</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3 text-center">
           <h2>Thank You</h2>
           <em>Copyright &copy; Switch 2017</em>
          </div>
        </div>
      </div>
    </footer>
